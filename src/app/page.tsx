    ...
    <main className="relative flex flex-col items-center justify-center min-h-screen p-6 bg-gradient-to-br from-[#c9d6ff] to-[#e2e2e2] text-center">
      ...
      {session ? (
        <div className="absolute top-6 right-6">
          <Button onClick={handleSignOut} className="px-4 py-2 text-sm font-medium shadow-md hover:scale-105 transition">
            Sign Out
          </Button>
        </div>):(
       <div className="absolute top-6 right-6">
        <Link href="/login">
          <Button className="px-4 py-2 text-sm font-medium shadow-md hover:scale-105 transition">
            Login / Signup
          </Button>
        </Link>
      </div>)}

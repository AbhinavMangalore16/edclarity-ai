...
const testimonials = [
  ...
  },
  {
    ...
    company: "Rio",
    content:
      "Content creation used to be a bottleneck in our workflow, but not anymore. This AI tool is intuitive and produces top-notch content every time. It's like having an extra team member who never sleeps!",
    categories: [1, 2, 5],
  },
  {
    ...
    company: "Canon",
    content:
      "The quality of the content generated by this AI tool is outstanding. It has taken our content marketing to new heights, allowing us to publish more frequently without compromising on quality.",
    categories: [1, 4],
  },
  {
    ...
    company: "Cadbury",
    content:
      "The AI-driven content tool has been a lifesaver for my marketing agency. We can now produce high-quality content for multiple clients quickly and efficiently.",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "Maffell",
    content:
      "I'm amazed at how well this AI-driven content tool performs. It's incredibly versatile and can generate content for blogs, social media, and even product descriptions effortlessly.",
    categories: [1, 3],
  },
  {
    ...
    company: "Binance",
    content:
      "I was blown away by how easy it was to create my content using this tool! Within a few hours, I had a professional-looking platform up and running.",
    categories: [1, 2, 5],
  },
  {
    ...
    company: "Forbes Inc.",
    content:
      "I've never been a fan of complicated website AI tools, which is why this is perfect for me. Its minimalist design and simple functionality make staying organized feel natural.",
    categories: [1, 4],
  },
  {
    ...
    company: "Ray Ban",
    content:
      "I've never been one for coding, so finding a tool that doesn't require technical skills was a dream come true. This exceeded my expectations.",
    categories: [1, 2],
  },
];

        ...
        <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-4 text-center md:pb-12">
            ...
            <h2 className="animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,var(--color-gray-200),var(--color-indigo-200),var(--color-gray-50),var(--color-indigo-300),var(--color-gray-200))] bg-[length:200%_auto] bg-clip-text pb-4 font-nacelle text-3xl font-semibold text-transparent md:text-4xl">
              Built for modern AI-powered education
            </h2>
            <p className="text-lg text-indigo-200/65">
              Deliver secure, real-time, and personalized learning experiences
              with infrastructure designed for students, educators, and teams.
            </p>
          </div>
          ...
          <div className="mx-auto grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-16 lg:grid-cols-3">
            <article>
              ...
              <p className="text-indigo-200/65">
                Support email/password and social providers with reliable session
            ...
            <article>
              ...
              <p className="text-indigo-200/65">
                Create specialized tutors per subject to provide focused help for
            ...
            <article>
              ...
              <p className="text-indigo-200/65">
                Search learning transcripts quickly to revisit explanations,
                formulas, and solved questions.
              </p>
            </article>
            <article>
              <svg
              ...
              <p className="text-indigo-200/65">
                Auto-generate concise summaries after every session so students
                can revise faster.
              </p>
            </article>
            <article>
              ...
              <p className="text-indigo-200/65">
                Monitor learner growth with structured analytics and measurable
            ...
            <article>
              ...
              <p className="text-indigo-200/65">
                Run interactive video and chat-based doubt-solving sessions with
